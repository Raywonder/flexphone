...
contextBridge.exposeInMainWorld('flexPhoneAPI', {
    ...
    recording: {
        ...
        getList: () => ipcRenderer.invoke('recording-get-list'),
        play: (filePath) => ipcRenderer.invoke('recording-play', filePath),
        delete: (filePath) => ipcRenderer.invoke('recording-delete', filePath),
        browseStorage: () => ipcRenderer.invoke('recording-browse-storage')
    },
